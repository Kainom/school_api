...
const whiteList = [ // permissão de dominios que podem usar esta api 
  'http://localhost:3001',
];
 
const corsOptions = { // origin se refere ao dominio que tenta acessar tal api,podendo ser undefine
